$(document).ready(function () {
    ...
    var note = locale === 'ar' ? 'لا يمكن حذف الباقه يوجد مشتركين بالفعل و يمكنك اختيار عدم التفعيل' : 'Package has current subscription users , you can use invalide option';
